...
public class HyBidInterstitialWrapper implements HyBidInterstitialAd.Listener {
    ...
    public void onInterstitialLoaded() {
        UnityPlayer.UnitySendMessage(mGameObjectName, "OnHyBidInterstitialLoadFinish", mAdId);
    }
    ...
    public void onInterstitialImpression() {
        UnityPlayer.UnitySendMessage(mGameObjectName, "OnHyBidInterstitialTrackImpression", mAdId);
        UnityPlayer.UnitySendMessage(mGameObjectName, "OnHyBidInterstitialViewShown", mAdId);
    }

    @Override
    public void onInterstitialClick() {
        UnityPlayer.UnitySendMessage(mGameObjectName, "OnHyBidInterstitialTrackClick", mAdId);
    }

    @Override
    public void onInterstitialDismissed() {
        UnityPlayer.UnitySendMessage(mGameObjectName, "OnHyBidInterstitialViewHidden", mAdId);
    }
}
